...
const urls = [
  'https://docs.google.com/document/d/1q9AhVA5jqIu6qwJbwIETC6IlKz3b_Fxx/edit',
  'https://docs.google.com/document/d/1j3T5RxlvKw340jDwlYv8nolWvYcqX6xZ/edit',
  'https://docs.google.com/document/d/1AoF_HkTl1ibuut0PlB81QCKXJujLVdR1/edit',
  'https://docs.google.com/document/d/119jYk6JL3yHYfZQKUrgCWULPlQGL4jpG/edit',
  'https://docs.google.com/document/d/1vc7oNHD4P3yXpkHAGt2XfXe-qO_X9bIq/edit'
];

const DOCTOR_SLUG = 'gopinath';
const DOCTOR_CATEGORY = 'General Medicine';
...
${htmlContent.trim()}
  ...
  console.log('Successfully appended blogs for Dr. Gopinath');
}
