export function EmergencyBanner({ phone = '+91 92479 58308', branchName = '' }) {
  return (
        ...
        <div className="flex items-center gap-6">
          ...
          <div>
            ...
            <p className="opacity-90 font-medium">
              {branchName ? `${branchName} Branch ` : ''}Emergency Trauma Support Available 24/7
            </p>
          </div>
        </div>
        <div className="text-center md:text-right">
          <p className="text-sm font-bold opacity-75 uppercase mb-1">Call Now</p>
          <a href="tel:+919247958308" className="text-4xl font-black tracking-tighter hover:opacity-90 transition-opacity">
            +91 92479 58308
          </a>
        </div>
      </div>
