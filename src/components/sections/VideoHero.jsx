          ...
          <div className="max-w-2xl">
            ...
            <div className="hero-btn-wrap flex flex-col sm:flex-row flex-wrap gap-3 md:gap-4">
              <button
                ...
                className="w-full sm:w-auto min-h-[48px] bg-gradient-to-br from-[#8B1A4A] to-[#5E0F30] text-white px-8 py-3 md:py-4 rounded-full font-label font-bold uppercase tracking-widest shadow-lg active:scale-95 transition-transform text-sm md:text-base cursor-pointer"
              >
                Book an Appointment
              </button>
              <button
