  ...
  const handleBookingAssistance = () => {
    openWhatsAppBooking({
      ...
      message: userName || userPhone 
        ? `Hello Srikara Hospitals, I would like to request booking assistance for ${userName || 'a patient'}${userPhone ? ` (Contact: ${userPhone})` : ''}.`
        : 'Hello Srikara Hospitals, I would like to request booking assistance.',
    });
  };
          ...
          {activeTab === 0 ? (
            ...
            <div className="flex flex-col sm:flex-row items-end gap-4 w-full">
              ...
              <button
                ...
                className="flex items-center gap-2 bg-[#6B2D8B] text-white px-8 py-3 rounded-full font-semibold text-sm hover:bg-[#5a2475] transition-all shadow-sm cursor-pointer"
              >
