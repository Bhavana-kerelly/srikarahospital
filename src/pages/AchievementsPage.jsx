...
import { ArrowLeft, ChevronRight, Trophy, Star, Sparkles, TrendingUp } from 'lucide-react'
...
export function AchievementsPage() {
  return (
    <>
      <Helmet>
        <title>Achievements | Discover Srikara Hospitals</title>
        <meta name="description" content="Discover key milestones, groundbreaking robotic surgeries, and historical achievements at Srikara Hospitals." />
      </Helmet>
        ...
        <section className="relative pt-32 pb-20 overflow-hidden">
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-4 md:px-8">
            ...
            <div className="flex items-center gap-2 text-xs font-semibold text-gray-500 mb-8">
              ...
              <span className="text-[#8B1A4A]">Achievements</span>
            </div>
            ...
            >
              ...
              <h1 className="text-4xl sm:text-5xl md:text-7xl font-bold tracking-tight mb-6 leading-[1.05]" style={{ fontFamily: "'Cormorant Garamond', serif" }}>
                Our Proud <span className="italic text-[#8B1A4A]">Achievements</span>
              </h1>
              <p className="text-base sm:text-lg text-[#4A4A4A] font-light leading-relaxed">
                From pioneering computer-navigated and robotic joint replacements to performing over 30,000 successful surgeries, explore the clinical milestones defining our history.
              </p>
            </motion.div>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto px-4 md:px-8">
            <div className="rounded-3xl border border-dashed border-[#8B1A4A]/25 bg-white/70 backdrop-blur-md p-12 md:p-20 text-center shadow-[0_10px_30px_rgba(139,26,74,0.03)]">
              ...
              <h2 className="text-2xl md:text-3xl font-bold text-[#1A202C] mb-3" style={{ fontFamily: "'Cormorant Garamond', serif" }}>
                Key Milestones & Clinical Breakthroughs
              </h2>
              <p className="text-[#718096] text-sm md:text-base max-w-xl mx-auto mb-8">
                Detailed timeline of surgical firsts, research milestones, and institutional achievements will appear here.
              </p>
              <Link
                to="/about"
