...
import { Calendar, Heart, Shield, Award, Users, MapPin, Activity, Star, Building2, Globe, Clock, Quote, Trophy, ArrowRight } from 'lucide-react'
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-[#FFF9FA] text-[#1A202C] selection:bg-[#8B1A4A] selection:text-white">
        ...
        {/* Sub-Hero Inner Page Navigation: Leadership, Awards & Recognition, Achievements */}
        <div className="relative z-20 max-w-6xl mx-auto px-4 -mt-2 mb-16">
          <motion.div
          ...
          >
            ...
            >
              <Users size={16} className="text-[#8B1A4A]" />
            ...
            <GlassButton
              ...
              contentClassName="flex items-center gap-2.5"
            >
              <Trophy size={16} className="text-[#8B1A4A]" />
        ...
        <section className="pt-4 md:pt-8 pb-16 md:pb-28 relative overflow-hidden">
        ...
        <TimelineSection />
        {/* Inside Srikara Gallery Section — Moved above footer */}
        <HospitalGallery />
        <Footer />
        <MobileBottomNav />
      </div>
