...
import { ArrowLeft, Users, Shield, Award, ChevronRight } from 'lucide-react'
...
export function LeadershipPage() {
  return (
    <>
      <Helmet>
        <title>Leadership | Discover Srikara Hospitals</title>
        <meta name="description" content="Meet the clinical and executive leadership steering Srikara Hospitals to clinical excellence." />
      </Helmet>
        ...
        <section className="relative pt-32 pb-20 overflow-hidden">
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-4 md:px-8">
            ...
            <div className="flex items-center gap-2 text-xs font-semibold text-gray-500 mb-8">
              ...
              <span className="text-[#8B1A4A]">Leadership</span>
            </div>
            ...
            >
              ...
              <h1 className="text-4xl sm:text-5xl md:text-7xl font-bold tracking-tight mb-6 leading-[1.05]" style={{ fontFamily: "'Cormorant Garamond', serif" }}>
                Executive & Clinical <span className="italic text-[#8B1A4A]">Leadership</span>
              </h1>
              <p className="text-base sm:text-lg text-[#4A4A4A] font-light leading-relaxed">
                Guided by world-renowned orthopedic surgeons, healthcare visionaries, and administrative pioneers committed to transforming compassionate care across AP & Telangana.
              </p>
            </motion.div>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto px-4 md:px-8">
            <div className="rounded-3xl border border-dashed border-[#8B1A4A]/25 bg-white/70 backdrop-blur-md p-12 md:p-20 text-center shadow-[0_10px_30px_rgba(139,26,74,0.03)]">
              ...
              <h2 className="text-2xl md:text-3xl font-bold text-[#1A202C] mb-3" style={{ fontFamily: "'Cormorant Garamond', serif" }}>
                Leadership Profiles & Governance
              </h2>
              <p className="text-[#718096] text-sm md:text-base max-w-xl mx-auto mb-8">
                Detailed profiles of our Board of Directors, Medical Directors, and Chief Clinical Officers will appear here.
              </p>
              <Link
                to="/about"
