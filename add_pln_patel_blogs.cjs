...
const urls = [
  'https://docs.google.com/document/d/1p-eZpxePpVSor7bgWt7CgpHfmctCr5W-/edit',
  'https://docs.google.com/document/d/1RXTn-SlIAkHddzbZNlOTCC6436lh9YGc/edit',
  'https://docs.google.com/document/d/1AQh9iSzwTWdlny7ITheHHgPlEtDBSEOi/edit',
  'https://docs.google.com/document/d/14GBQijViJk2uPt3LcQIA92WxExwVumAz/edit',
  'https://docs.google.com/document/d/1Wg9wPidr9HQgwKP0p-ncmok8FHtGMfKX/edit'
];

const DOCTOR_SLUG = 'pln-patel';
const DOCTOR_CATEGORY = 'Cardiology'; // Assuming Cardiology based on grep search
...
${htmlContent.trim()}
  ...
  console.log('Successfully appended blogs for Dr. PLN Patel');
}
