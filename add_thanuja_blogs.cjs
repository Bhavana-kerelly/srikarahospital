...
const urls = [
  'https://docs.google.com/document/d/1LmYddgv6hB26om8ztUQegDQNHcdYmyyf/edit',
  'https://docs.google.com/document/d/1FuLJU231ZTR4q-Yxf5_fiwhqgy1e3PNG/edit',
  'https://docs.google.com/document/d/1c-2XDoJSL5SG9BMrcA7YIIY-q22v4s8L/edit',
  'https://docs.google.com/document/d/16mjWAs8kRHqGM3nRmYgjeJyXr3Hls_qk/edit',
  'https://docs.google.com/document/d/1OugYYzHcaKjmX2J--dZxTcTt4uKOS6_o/edit'
];

const DOCTOR_SLUG = 'thanuja-peddireddla';
const DOCTOR_CATEGORY = 'Pulmonology';
...
${htmlContent.trim()}
  ...
  console.log('Successfully appended blogs for Dr. THANUJA PEDDIREDDLA');
}
