...
const files = [
  'C:/Users/bhava/.gemini/antigravity-ide/brain/90707371-8461-4614-bbae-d1fa5b3e1d0f/.system_generated/steps/721/content.md',
  'C:/Users/bhava/.gemini/antigravity-ide/brain/90707371-8461-4614-bbae-d1fa5b3e1d0f/.system_generated/steps/722/content.md',
  'C:/Users/bhava/.gemini/antigravity-ide/brain/90707371-8461-4614-bbae-d1fa5b3e1d0f/.system_generated/steps/723/content.md',
  'C:/Users/bhava/.gemini/antigravity-ide/brain/90707371-8461-4614-bbae-d1fa5b3e1d0f/.system_generated/steps/724/content.md',
  'C:/Users/bhava/.gemini/antigravity-ide/brain/90707371-8461-4614-bbae-d1fa5b3e1d0f/.system_generated/steps/725/content.md'
];
...
function processMarkdown(filePath, index) {
  ...
  return `
  {
    ...
    date: '18 Sep 2026',
    readTime: '4 min read',
    image: '/images/doctor-blogs/sameer-hanu-maharshi-blog-${index + 1}.jpg',
...
// Note: ensure we add a leading comma before inserting newBlogs to avoid SyntaxError
const lastBracketIndex = existingContent.lastIndexOf('];');
if (lastBracketIndex !== -1) {
  // Let's strip trailing whitespace before the bracket
